__global__ void mm_kernel(float *C_odata, float *A_idata, float *B_idata, int N)
// Naive kernel
{
...
__global__ void mm_kernel2(float *C_odata, float *A_idata, float *B_idata, int N)
...
__global__ void mm_kernel3(float *C_odata, float *A_idata, float *B_idata, int N)
{
...
__global__ void mm_kernel4(float *C_odata, float *A_idata, float *B_idata, int N)
{
...
__global__ void mm_kernel5(float *C_odata, float *A_idata, float *B_idata, int N)
{
